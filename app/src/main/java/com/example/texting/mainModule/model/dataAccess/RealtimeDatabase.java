...
public class RealtimeDatabase {
    ...
    public void removeUser(String friendUid, String myUid, final BaseEventCallback callback) {
    ...
    public void acceptRequest(User user, User myUser, final BaseEventCallback callback) {
        ...
        acceptRequest.put(FirebaseRealtimeDatabaseAPI.PATH_REQUEST + "/" + emailEncoded + "/"
                + user.getUid(), null);
    ...
    public void denyRequest(User user, String myEmail, final BaseEventCallback callback){
